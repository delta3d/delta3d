...
void InitializeUpdateMessage::operator ()(dtGame::ActorUpdateMessage& msg) const
{
   ...
   //DIS::EntityType aet;
   //aet.setCategory(1);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_category", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(aet.getCategory()) );
   //aet.setCountry(2);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_country", dtCore::DataType::SHORTINT );
   //mp->FromString( dtUtil::ToString(aet.getCountry()) );
   //aet.setDomain(3);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_domain", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(aet.getDomain()) );
   //aet.setEntityKind(4);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_entitykind", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(aet.getEntityKind()) );
   //aet.setExtra(5);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_extra", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(aet.getExtra()) );
   //aet.setSpecific(6);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_specific", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(aet.getSpecific()) );
   //aet.setSubcategory(7);
   //mp = msg.AddUpdateParameter("dis_alternative_entitytype_subcategory", dtCore::DataType::CHAR );
   ...
   //mp = msg.AddUpdateParameter("dis_articulation_parameter_count", dtCore::DataType::CHAR );
   ...
   //mp = msg.AddUpdateParameter("dis_capabilities", dtCore::DataType::INT );
   ...
   //mp = msg.AddUpdateParameter("dis_dead_reckoning_algorithm", dtCore::DataType::CHAR );
   ...
   ////mp = msg.AddUpdateParameter("dis_dead_reckoning_linear_acceleration", dtCore::DataType::VEC3F );
   ...
   ////mp = msg.AddUpdateParameter("dis_dead_reckoning_entity_angular_velocity", dtCore::DataType::VEC3F );
   ////mp->FromString( dtUtil::ToString(drp.getEntityAngularVelocity()) );

   //pdu.setEntityAppearance(22);
   mp = msg.AddUpdateParameter(dtDIS::EntityPropertyName::APPEARANCE, dtCore::DataType::INT );
   mp->FromString( dtUtil::ToString(22) );

   DIS::EntityID eid;
   eid.setSite(23);
   //mp = msg.AddUpdateParameter(dtDIS::PropertyName::ENTITYID_SITE, dtCore::DataType::SHORTINT );
   //mp->FromString( dtUtil::ToString(eid.getSite()) );
   eid.setApplication(24);
   //mp = msg.AddUpdateParameter(dtDIS::PropertyName::ENTITYID_APPLICATION, dtCore::DataType::SHORTINT );
   //mp->FromString( dtUtil::ToString(eid.getApplication()) );
   eid.setEntity(25);
   //////mp = msg.AddUpdateParameter(dtDIS::PropertyName::ENTITYID_ENTITY, dtCore::DataType::SHORTINT );
   //////mp->FromString( dtUtil::ToString(eid.getEntity()) );

   mp = msg.AddUpdateParameter(dtDIS::EnginePropertyName::ENTITY_LINEARY_VELOCITY, dtCore::DataType::VEC3 );
   if (mp != NULL)
   {
   ...
   mp = msg.AddUpdateParameter( dtDIS::EnginePropertyName::ENTITY_LOCATION , dtCore::DataType::VEC3 );
   if( mp != NULL )
   {
      dtGame::Vec3MessageParameter* v3mp = static_cast<dtGame::Vec3MessageParameter*>( mp );
   ...
   mp = msg.AddUpdateParameter( dtDIS::EnginePropertyName::ENTITY_ORIENTATION , dtCore::DataType::VEC3 );
   if( mp != NULL )
   {
      dtGame::Vec3MessageParameter* v3mp = static_cast<dtGame::Vec3MessageParameter*>( mp );
   ...
   mp = msg.AddUpdateParameter(dtDIS::EnginePropertyName::LAST_KNOWN_ORIENTATION, dtCore::DataType::VEC3);
   if( mp != NULL )
   {
      dtGame::Vec3MessageParameter* v3mp = static_cast<dtGame::Vec3MessageParameter*>( mp );
      v3mp->SetValue( osg::Vec3(34, 33, 32) );
   ...
   mp = msg.AddUpdateParameter(dtDIS::EnginePropertyName::LAST_KNOWN_LOCATION, dtCore::DataType::VEC3);
   if( mp != NULL )
   {
      dtGame::Vec3MessageParameter* v3mp = static_cast<dtGame::Vec3MessageParameter*>( mp );
      v3mp->SetValue( osg::Vec3(29, 30, 31) );
   ...
   //DIS::EntityType et;
   //et.setCategory(35);
   //mp = msg.AddUpdateParameter("dis_entitytype_category", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(et.getCategory()) );
   //et.setCountry(36);
   //mp = msg.AddUpdateParameter("dis_entitytype_country", dtCore::DataType::SHORTINT );
   //mp->FromString( dtUtil::ToString(et.getCountry()) );
   //et.setDomain(37);
   //mp = msg.AddUpdateParameter("dis_entitytype_domain", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(et.getDomain()) );
   //et.setEntityKind(38);
   //mp = msg.AddUpdateParameter("dis_entitytype_entitykind", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(et.getEntityKind()) );
   //et.setExtra(39);
   //mp = msg.AddUpdateParameter("dis_entitytype_extra", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(et.getExtra()) );
   //et.setSpecific(40);
   //mp = msg.AddUpdateParameter("dis_entitytype_specific", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(et.getSpecific()) );
   //et.setSubcategory(41);
   //mp = msg.AddUpdateParameter("dis_entitytype_subcategory", dtCore::DataType::CHAR );
   //mp->FromString( dtUtil::ToString(et.getSubcategory()) );
   ////pdu.setEntityType( et );

   ////pdu.setExerciseID(42);
   //mp = msg.AddUpdateParameter("dis_exerciseid", dtCore::DataType::UCHAR );
   //mp->FromString( dtUtil::ToString(42) );

   ////pdu.setForceId(43);
   //mp = msg.AddUpdateParameter("dis_forceid", dtCore::DataType::UCHAR );
   ...
   //mp = msg.AddUpdateParameter("dis_length", dtCore::DataType::USHORTINT );
   ...
   ////pdu.setPadding(56);
   //mp = msg.AddUpdateParameter("dis_padding", dtCore::DataType::SHORTINT );
   //mp->FromString( dtUtil::ToString(56) );

   /////\todo the pdu should probably assign this and the interface should not be public
   ////pdu.setPduType(57);
   //mp = msg.AddUpdateParameter("dis_pdutype", dtCore::DataType::UCHAR );
   //mp->FromString( dtUtil::ToString(57) );

   /////\todo this interface should probably not be public too
   ////pdu.setProtocolFamily(58);
   //mp = msg.AddUpdateParameter("dis_protocolfamily", dtCore::DataType::UCHAR );
   //mp->FromString( dtUtil::ToString(58) );

   /////\todo this interface should probably not be public too
   ////pdu.setProtocolVersion(59);
   //mp = msg.AddUpdateParameter("dis_protocolversion", dtCore::DataType::UCHAR );
   //mp->FromString( dtUtil::ToString(59) );

   ////pdu.setTimestamp(60);
   //mp = msg.AddUpdateParameter("dis_timestamp", dtCore::DataType::UINT );

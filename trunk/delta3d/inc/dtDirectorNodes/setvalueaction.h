...
#ifndef SET_VALUE_ACTION_NODE
#define SET_VALUE_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT SetValueAction: public ActionNode
   {
   public:
      ...
      void SetDest(const std::string& value);

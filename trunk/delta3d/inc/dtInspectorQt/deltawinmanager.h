...
#ifndef deltawinmanager_h__
#define deltawinmanager_h__
...
namespace dtInspectorQt
{
   ...
   class DeltaWinManager : public IManager
   {
      Q_OBJECT

   public:
      DeltaWinManager(Ui::InspectorWidget &ui);
      virtual ~DeltaWinManager();

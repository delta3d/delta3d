...
#ifndef skydomemanager_h__
#define skydomemanager_h__
...
namespace dtInspectorQt
{
   ...
   class SkyDomeManager : public IManager
   {
      Q_OBJECT

   public:
      SkyDomeManager(Ui::InspectorWidget &ui);
      virtual ~SkyDomeManager();

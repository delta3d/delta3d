...
namespace dtGame
{
   ...
   class DT_GAME_EXPORT TaskComponent : public GMComponent
   {
      ...
      protected:
          ...
          */
         void InsertTaskActor(const GameActorProxy &taskProxy);
          ...
          */
         void RemoveTaskActor(const GameActorProxy &toRemove);
      ...
      private:
         std::set<dtCore::UniqueId> mTopLevelTaskList;
         std::set<dtCore::UniqueId> mTaskList;
   };

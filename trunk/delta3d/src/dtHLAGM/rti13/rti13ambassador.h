...
#ifndef RTI13AMBASSADOR_H_
#define RTI13AMBASSADOR_H_
...
namespace dtHLAGM
{
   ...
   private:
      ...
      RTI13AmbassadorImpl* mImpl;
   };
}
#endif /* RTI13AMBASSADOR_H_ */

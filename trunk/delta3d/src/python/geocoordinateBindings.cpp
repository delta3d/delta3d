...
void initGeoCoordinatesBindings()
{
	...
	//void (GeoCoordinates::*SetCP1)(osg::Vec3&) = &GeoCoordinates::SetCartesianPoint;

	//const osg::Vec3& (GeoCoordinates::*GetCP0)() = &GeoCoordinates::GetCartesianPoint;
	...
	class_<GeoCoordinates, GeoCoordinates*, boost::noncopyable>("GeoCoordinates")
		...
		.def("SetCartesianPoint", &GeoCoordinates::SetCartesianPoint)

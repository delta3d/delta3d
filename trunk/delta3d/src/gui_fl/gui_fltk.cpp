...
inline void UserInterface::cb_LightX_i(Fl_Value_Input* o, void* v) {
  ((UserInterface*)v)->LightPosCB(o);
}
void UserInterface::cb_LightX(Fl_Value_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_LightX_i(o,v);
}

inline void UserInterface::cb_LightY_i(Fl_Value_Input* o, void* v) {
  ((UserInterface*)v)->LightPosCB(o);
}
void UserInterface::cb_LightY(Fl_Value_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_LightY_i(o,v);
}

inline void UserInterface::cb_LightZ_i(Fl_Value_Input* o, void* v) {
  ((UserInterface*)v)->LightPosCB(o);
}
void UserInterface::cb_LightZ(Fl_Value_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_LightZ_i(o,v);
}

inline void UserInterface::cb_LightDirX_i(Fl_Value_Input* o, void* v) {
  ((UserInterface*)v)->LightDirCB(o);
}
void UserInterface::cb_LightDirX(Fl_Value_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_LightDirX_i(o,v);
}

inline void UserInterface::cb_LightDirY_i(Fl_Value_Input* o, void* v) {
  ((UserInterface*)v)->LightDirCB(o);
}
void UserInterface::cb_LightDirY(Fl_Value_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_LightDirY_i(o,v);
}

inline void UserInterface::cb_LightDirZ_i(Fl_Value_Input* o, void* v) {
  ((UserInterface*)v)->LightDirCB(o);
}
void UserInterface::cb_LightDirZ(Fl_Value_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_LightDirZ_i(o,v);
}
...
s)");
    ...
    { Fl_Group* o = LightGroup = new Fl_Group(30, 170, 505, 260);
      o->box(FL_ENGRAVED_BOX);
      o->labeltype(FL_EMBOSSED_LABEL);
      o->user_data((void*)(this));
      o->hide();
      { Fl_Value_Input* o = LightNumberInput = new Fl_Value_Input(75, 180, 25, 25, "Num:");
        o->minimum(1);
        o->maximum(8);
        o->step(1);
        o->callback((Fl_Callback*)cb_LightNumberInput, (void*)(this));
      }
      { Fl_Group* o = new Fl_Group(40, 230, 65, 45, "Mode");
        o->box(FL_ENGRAVED_FRAME);
        { Fl_Round_Button* o = LightModeLocal = new Fl_Round_Button(40, 230, 65, 25, "Local");
          o->type(102);
          o->down_box(FL_ROUND_DOWN_BOX);
          o->callback((Fl_Callback*)cb_LightModeLocal, (void*)(this));
        }
        { Fl_Round_Button* o = LightModeGlobal = new Fl_Round_Button(40, 250, 65, 25, "Global");
          o->type(102);
          o->down_box(FL_ROUND_DOWN_BOX);
          o->value(1);
      ...
      { Fl_Group* o = new Fl_Group(175, 195, 70, 80, "Attenuation");
        { Fl_Value_Input* o = LightConstAtt = new Fl_Value_Input(180, 195, 60, 25, "Constant:");
          o->maximum(100);
          o->step(0.001);
          o->callback((Fl_Callback*)cb_LightConstAtt, (void*)(this));
        }
        { Fl_Value_Input* o = LightLinAtt = new Fl_Value_Input(180, 220, 60, 25, "Linear:");
          o->maximum(100);
          o->step(0.001);
          o->callback((Fl_Callback*)cb_LightLinAtt, (void*)(this));
        }
        { Fl_Value_Input* o = LightQuadAtt = new Fl_Value_Input(180, 245, 60, 25, "Quadratic:");
          o->maximum(100);
          o->step(0.001);
      ...
      { Fl_Group* o = new Fl_Group(50, 305, 130, 85, "Diffuse");
        o->box(FL_THIN_DOWN_FRAME);
        { Fl_Value_Input* o = LightDifRed = new Fl_Value_Input(100, 310, 45, 25, "Red:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightDifRed, (void*)(this));
        }
        { Fl_Value_Input* o = LightDifGreen = new Fl_Value_Input(100, 335, 45, 25, "Green:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightDifGreen, (void*)(this));
        }
        { Fl_Value_Input* o = LightDifBlue = new Fl_Value_Input(100, 360, 45, 25, "Blue:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightDifBlue, (void*)(this));
        }
        { Fl_Button* o = LightDifColorLoadButton = new Fl_Button(150, 310, 25, 75, "...");
          o->callback((Fl_Callback*)cb_LightDifColorLoadButton, (void*)(this));
        }
        o->end();
      }
      { Fl_Group* o = new Fl_Group(210, 305, 130, 85, "Ambient");
        o->box(FL_THIN_DOWN_FRAME);
        { Fl_Value_Input* o = LightAmbRed = new Fl_Value_Input(260, 310, 45, 25, "Red:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightAmbRed, (void*)(this));
        }
        { Fl_Value_Input* o = LightAmbGreen = new Fl_Value_Input(260, 335, 45, 25, "Green:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightAmbGreen, (void*)(this));
        }
        { Fl_Value_Input* o = LightAmbBlue = new Fl_Value_Input(260, 360, 45, 25, "Blue:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightAmbBlue, (void*)(this));
        }
        { Fl_Button* o = LightAmbColorLoadButton = new Fl_Button(310, 310, 25, 75, "...");
          o->callback((Fl_Callback*)cb_LightAmbColorLoadButton, (void*)(this));
        }
        o->end();
      }
      { Fl_Group* o = new Fl_Group(375, 305, 130, 85, "Specular");
        o->box(FL_THIN_DOWN_FRAME);
        { Fl_Value_Input* o = LightSpecRed = new Fl_Value_Input(425, 310, 45, 25, "Red:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightSpecRed, (void*)(this));
        }
        { Fl_Value_Input* o = LightSpecGreen = new Fl_Value_Input(425, 335, 45, 25, "Green:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightSpecGreen, (void*)(this));
        }
        { Fl_Value_Input* o = LightSpecBlue = new Fl_Value_Input(425, 360, 45, 25, "Blue:");
          o->step(0.01);
          o->value(8.888);
          o->callback((Fl_Callback*)cb_LightSpecBlue, (void*)(this));
        }
        { Fl_Button* o = LightSpecColorLoadButton = new Fl_Button(475, 310, 25, 75, "...");
          o->callback((Fl_Callback*)cb_LightSpecColorLoadButton, (void*)(this));
        }
        o->end();
      }
      { Fl_Group* o = new Fl_Group(390, 195, 60, 75, "Position");
        { Fl_Value_Input* o = LightX = new Fl_Value_Input(390, 195, 60, 25, "X:");
          o->minimum(-500000);
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightX, (void*)(this));
        }
        { Fl_Value_Input* o = LightY = new Fl_Value_Input(390, 220, 60, 25, "Y:");
          o->minimum(-500000);
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightY, (void*)(this));
        }
        { Fl_Value_Input* o = LightZ = new Fl_Value_Input(390, 245, 60, 25, "Z:");
          o->minimum(-500000);
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightZ, (void*)(this));
        }
        o->end();
      }
      { Fl_Group* o = new Fl_Group(475, 195, 50, 75, "Direction");
        { Fl_Value_Input* o = LightDirX = new Fl_Value_Input(475, 195, 50, 25, "X:");
          o->minimum(-500000);
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightDirX, (void*)(this));
        }
        { Fl_Value_Input* o = LightDirY = new Fl_Value_Input(475, 220, 50, 25, "Y:");
          o->minimum(-500000);
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightDirY, (void*)(this));
        }
        { Fl_Value_Input* o = LightDirZ = new Fl_Value_Input(475, 245, 50, 25, "Z:");
          o->minimum(-500000);
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightDirZ, (void*)(this));
        }
        o->end();
      }
      { Fl_Group* o = new Fl_Group(300, 195, 60, 50, "Spot");
        { Fl_Value_Input* o = LightExponentInput = new Fl_Value_Input(300, 195, 60, 25, "Exp:");
          o->maximum(500000);
          o->step(0.1);
          o->callback((Fl_Callback*)cb_LightExponentInput, (void*)(this));
        }
        { Fl_Value_Input* o = LightCutoffInput = new Fl_Value_Input(300, 220, 60, 25, "Cutoff:");
          o->maximum(500000);
          o->step(0.1);

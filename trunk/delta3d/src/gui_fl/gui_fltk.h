...
private:
  ...
  Fl_Value_Input *LightDirX;
  inline void cb_LightDirX_i(Fl_Value_Input*, void*);
  static void cb_LightDirX(Fl_Value_Input*, void*);
  Fl_Value_Input *LightDirY;
  inline void cb_LightDirY_i(Fl_Value_Input*, void*);
  static void cb_LightDirY(Fl_Value_Input*, void*);
  Fl_Value_Input *LightDirZ;
  inline void cb_LightDirZ_i(Fl_Value_Input*, void*);
  static void cb_LightDirZ(Fl_Value_Input*, void*);
...
private:
  ...
  void LightPosCB(Fl_Value_Input*);
  ...
  void LightDirCB(Fl_Value_Input*);
};

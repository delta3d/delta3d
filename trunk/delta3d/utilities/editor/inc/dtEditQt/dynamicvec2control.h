...
namespace dtEditQt 
{
    ...
    */
    ...
    private: 
        ...
        osg::ref_ptr<dtDAL::Vec2ActorProperty>  myVec2Property;
        osg::ref_ptr<dtDAL::Vec2fActorProperty> myVec2fProperty;
        osg::ref_ptr<dtDAL::Vec2dActorProperty> myVec2dProperty;
    };

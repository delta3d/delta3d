...
namespace dtCore
{
   ...
   /////////////////////////////////////////////////////////////////////////////
   BaseActorObject::BaseActorObject(const ActorType* actorType)
   ...
   {
      // Set the actor type only if it is changing.
      // It could have already been set.
      if (mActorType.get() != &actorType)
      {

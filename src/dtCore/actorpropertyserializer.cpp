...
namespace dtCore
{
   ...
   bool ActorPropertySerializer::ElementStarted(const XMLCh* const localname)
   {
         ...
         MapXMLConstants::ACTOR_PROPERTY_ELEMENT) == 0)
      {
         ...
         MapXMLConstants::ACTOR_CHILDREN_ELEMENT) == 0)
      {
         data.mInActorChildren = true;
         return true;
      }
   ...
   bool ActorPropertySerializer::ElementEnded(const XMLCh* const localname)
   {
      ...
      else if (data.mInActorChildren)
      {
         if (XMLString::compareString(localname, MapXMLConstants::ACTOR_CHILDREN_ELEMENT) == 0)
         {
            data.mInActorChildren = false;
            return true;
         }
      }

...
namespace dtCore
{
   ...
   void Map::SetEnvironmentActor(BaseActor* envActor)
   {
      if (envActor == NULL)
      {
   ...
   //////////////////////////////////////////////////////////////////////////
   BaseActor* Map::GetEnvironmentActor()
   {
      return mEnvActor.get();
   }

   //////////////////////////////////////////////////////////////////////////
   const BaseActor* Map::GetEnvironmentActor() const
   {
      return mEnvActor.get();
   }

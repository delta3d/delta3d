...
namespace dtAnim
{
   ...
   const OsgExtensionEnum OsgExtensionEnum::MAKE_HUMAN_TARGET("target", MORPH_FILE, "MakeHuman Morph Target File (text)");
   const OsgExtensionEnum OsgExtensionEnum::MAKE_HUMAN_EXCHANGE("mhx", MIXED_FILE, "MakeHuman Exchange File (text)");

...
namespace dtUtil
{
   ...
   NodeMask NodeMask::TERRAIN_FEATURES("TERRAIN_FEATURES", 0xF0000000);
   NodeMask NodeMask::DEFAULT("DEFAULT", 0x00FFFFFF);
   NodeMask NodeMask::SHADOW_RECEIVE("SHADOW_RECEIVE", 0x00000010);
   NodeMask NodeMask::SHADOW_CAST("SHADOW_CAST", 0x00000020);

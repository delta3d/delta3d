...
namespace dtRender
{
   ...
   const dtCore::ActorComponent::ACType OptimzerActComp::TYPE(new dtCore::ActorType("OptimzerActComp", "ActorComponents",
   ...
   : BaseClass(OptimzerActComp::TYPE)
   ...
   void OptimzerActComp::OnAddedToActor(dtCore::BaseActor& actor)
   {
      BaseClass::OnAddedToActor(actor);
   }

   void OptimzerActComp::OnRemovedFromActor(dtCore::BaseActor& actor)
   {

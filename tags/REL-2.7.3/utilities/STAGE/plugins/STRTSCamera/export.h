#ifndef DELTA_RTS_CAMERA_EXPORT
#define DELTA_RTS_CAMERA_EXPORT
...
#  ifdef DT_RTS_CAMERA_PLUGIN
#    define DT_RTS_CAMERA_EXPORT __declspec(dllexport)
#  else
#    define DT_RTS_CAMERA_EXPORT __declspec(dllimport)
#  endif
#else
#  ifdef DT_RTS_CAMERA_PLUGIN
#    define DT_RTS_CAMERA_EXPORT  __attribute__ ((visibility("default")))
#  else
#    define DT_RTS_CAMERA_EXPORT
#  endif
#endif

#endif // DELTA_RTS_CAMERA_EXPORT

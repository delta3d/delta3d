...
#ifndef DIRECTOR_PLAYER_VALUE_NODE
#define DIRECTOR_PLAYER_VALUE_NODE
...
{
   /**
    * This is a valud node that retrieves the current player.
    *
    * @note
    ...
    */
   class NODE_LIBRARY_EXPORT PlayerValue : public ValueNode
   {
   public:

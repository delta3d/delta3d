...
instructions in src/readme.txt for building from source. Otherwise, use the 
.exe in the Release folders.
...
of HLA is not distrubted with Delta3D. Please see examples/testHLA/readme.txt

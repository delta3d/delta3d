#ifndef DELTA_MASS_IMPORTER_EXPORT
#define DELTA_MASS_IMPORTER_EXPORT
...
#  ifdef DT_MASS_IMPORTER_PLUGIN
#    define DT_MASS_IMPORTER_EXPORT __declspec(dllexport)
#  else
#    define DT_MASS_IMPORTER_EXPORT __declspec(dllimport)
#  endif
#else
#  ifdef DT_MASS_IMPORTER_PLUGIN
#    define DT_MASS_IMPORTER_EXPORT  __attribute__ ((visibility("default")))
#  else
#    define DT_MASS_IMPORTER_EXPORT
#  endif
#endif

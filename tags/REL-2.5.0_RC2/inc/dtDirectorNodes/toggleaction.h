...
#ifndef TOGGLE_ACTION_NODE
#define TOGGLE_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT ToggleAction: public ActionNode
   {
   public:
       ...
       */
      void SetToggleActor(const dtCore::UniqueId& value);
      dtCore::UniqueId GetToggleActor();

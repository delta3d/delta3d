...
#ifndef GET_ACTOR_PARENT_ACTION_NODE
#define GET_ACTOR_PARENT_ACTION_NODE
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT GetParentActorAction: public ActionNode
   {
   public:

      GetParentActorAction();
      ...
      void SetParentActor(const dtCore::UniqueId& value);
      dtCore::UniqueId GetParentActor() const;
   ...
   private:
      ...
      dtCore::UniqueId mParent;
   };
}

////////////////////////////////////////////////////////////////////////////////

#endif // GET_ACTOR_PARENT_ACTION_NODE

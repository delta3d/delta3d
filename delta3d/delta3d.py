...
########################
   ...
   def CreateConf(env, errorLog):
      ...
      if env['OS'] == 'darwin' :
        ...
        env['SHLINKFLAGS'] = '$LINKFLAGS -Wl,-single_module -dynamiclib -compatibility_version 2 -current_version 2 -install_name "' + os.path.abspath(env.get('prefix')) + '/lib/$SHLIBPREFIX$LIBNAME$SHLIBSUFFIX"'

...
#ifndef DELTA_VR_ACTOR_REGISTRY
#define DELTA_VR_ACTOR_REGISTRY
...
namespace dtVR
{
    ...
    */
   class DT_VR_EXPORT OpenVRActorRegistry : public dtCore::ActorPluginRegistry
   {
   public:
      
      static dtCore::RefPtr<dtCore::ActorType> OPENVR_SCENE_ACTOR_TYPE;

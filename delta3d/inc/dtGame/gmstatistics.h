   ...
   class GMStatistics
   {
      ...
      protected:
         ...
         */
         ...
         bool ShouldWeLogActors() {return (mStatisticsInterval > 0 && mDoStatsOnTheActors);}
         
         /// GM calls this for checking to see to do stats
         bool ShouldWeLogComponents() {return (mStatisticsInterval > 0 && mDoStatsOnTheComponents);}

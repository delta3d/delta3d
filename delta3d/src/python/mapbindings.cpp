...
void initMapBindings()
{
   ...
   scope Map_scope = class_< Map, dtCore::RefPtr<Map>, boost::noncopyable >( "Map", no_init )
      ...
      .def( "GetSavedName", &Map::GetSavedName, return_internal_reference<>() )
      .def( "SetName", &Map::SetName )
      .def( "GetFileName", &Map::GetFileName, return_internal_reference<>() )
      .def( "GetDescription", &Map::GetDescription, return_internal_reference<>() )
      .def( "SetDescription", &Map::SetDescription )
      .def( "GetAuthor", &Map::GetAuthor, return_internal_reference<>() )
      .def( "SetAuthor", &Map::SetAuthor )
      .def( "GetComment", &Map::GetComment, return_internal_reference<>() )
      .def( "SetComment", &Map::SetComment )
      .def( "GetCopyright", &Map::GetCopyright, return_internal_reference<>() )

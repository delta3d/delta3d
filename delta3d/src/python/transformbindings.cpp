...
void initTransformBindings()
{
   ...
   class_<Transform>("Transform", init<optional<float, float, float, float, float, float> >())
      ...
      .def("GetTranslationX", &Transform::GetTranslationX)
      .def("GetTranslationY", &Transform::GetTranslationY)
      .def("GetTranslationZ", &Transform::GetTranslationZ)
   ...
   void (Transform::*GetTranslation1)(float&, float&, float&) const = &Transform::GetTranslation;

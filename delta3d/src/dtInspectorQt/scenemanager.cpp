...
//////////////////////////////////////////////////////////////////////////
dtInspectorQt::SceneManager::SceneManager(Ui::InspectorWidget& ui)
:mUI(&ui)
{
...
//////////////////////////////////////////////////////////////////////////
dtInspectorQt::SceneManager::~SceneManager()
{
   mOperateOn = NULL;
}

//////////////////////////////////////////////////////////////////////////
void dtInspectorQt::SceneManager::OperateOn(dtCore::Base* b)
{
...
//////////////////////////////////////////////////////////////////////////
void dtInspectorQt::SceneManager::Update()
{
   if (mOperateOn.valid())
   {
...
//////////////////////////////////////////////////////////////////////////
void dtInspectorQt::SceneManager::OnUseSceneLight(int state)
{
   if (mOperateOn.valid())
   {
...
//////////////////////////////////////////////////////////////////////////
void dtInspectorQt::SceneManager::OnRenderStateChanged(int mode)
{
   if (mOperateOn.valid())
   {

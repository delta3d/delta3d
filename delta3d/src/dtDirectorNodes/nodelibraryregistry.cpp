...
namespace dtDirector
{
   ...
   RefPtr<NodeType> NodeLibraryRegistry::REFERENCE_SCRIPT_ACTION_NODE_TYPE(      new dtDirector::NodeType("Reference Script Action",   "Core",        "Macros",      "References an external Director script resource."));

...
namespace dtDirector
{
   ...
   RefPtr<NodeType> NodeLibraryRegistry::PLAYER_VALUE_NODE_TYPE(                 new dtDirector::NodeType(dtDirector::NodeType::VALUE_NODE,  "Player",                    "Core",        "Actors",      "The player actor.", NULL, Colors::MANGENTA2, dtDAL::DataType::ACTOR));
   RefPtr<NodeType> NodeLibraryRegistry::OWNER_VALUE_NODE_TYPE(                  new dtDirector::NodeType(dtDirector::NodeType::VALUE_NODE,  "Owner",                     "Core",        "Actors",      "The owner actor of this script.", NULL, Colors::MANGENTA2, dtDAL::DataType::ACTOR));

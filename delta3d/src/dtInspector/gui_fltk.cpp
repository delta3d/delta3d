...
Fl_Double_Window* UserInterface::make_window() {
  ...
  { Fl_Double_Window* o = MainWindow = new Fl_Double_Window(545, 555, "dtCore");
    ...
    { Fl_Group* o = DrawableGroup = new Fl_Group(10, 145, 230, 105, "Drawable");
      o->box(FL_ENGRAVED_FRAME);
      o->align(FL_ALIGN_TOP_LEFT);
      o->hide();
      { Fl_Browser* o = DrawableChildList = new Fl_Browser(70, 180, 135, 65, "Children");
        o->type(3);
      ...
      { Fl_Output* o = DrawableParentText = new Fl_Output(75, 150, 130, 25, "Parent:");
        o->box(FL_ENGRAVED_FRAME);
      }
      o->end();
    }
    { Fl_Group* o = TransformGroup = new Fl_Group(245, 145, 295, 105, "Transformable");
      o->box(FL_ENGRAVED_FRAME);
      o->align(FL_ALIGN_TOP_LEFT);
      o->hide();
...
s)");
    ...
    { Fl_Group* o = PositionalLightGroup = new Fl_Group(280, 259, 235, 71);
      o->box(FL_ENGRAVED_BOX);
      o->user_data((void*)(this));
      o->hide();
      { Fl_Group* o = new Fl_Group(290, 275, 205, 50, "Attenuation");
        o->box(FL_THIN_DOWN_BOX);
        { Fl_Value_Input* o = LightConstAtt = new Fl_Value_Input(295, 295, 60, 25, "Constant");
          o->maximum(100);
          o->step(0.001);
          o->callback((Fl_Callback*)cb_LightConstAtt, (void*)(this));
          o->align(FL_ALIGN_TOP);
        }
        { Fl_Value_Input* o = LightLinAtt = new Fl_Value_Input(360, 295, 60, 25, "Linear");
          o->maximum(100);
          o->step(0.001);
          o->callback((Fl_Callback*)cb_LightLinAtt, (void*)(this));
          o->align(FL_ALIGN_TOP);
        }
        { Fl_Value_Input* o = LightQuadAtt = new Fl_Value_Input(427, 295, 60, 25, "Quadratic");
          o->maximum(100);
          o->step(0.001);
    ...
    { Fl_Group* o = LightSpotGroup = new Fl_Group(130, 279, 139, 50, "Spot");
      o->box(FL_THIN_DOWN_BOX);
      o->hide();
      { Fl_Value_Input* o = LightExponentInput = new Fl_Value_Input(202, 300, 60, 25, "Exp");
        o->maximum(500000);
        o->step(0.1);
        o->callback((Fl_Callback*)cb_LightExponentInput, (void*)(this));
        o->align(FL_ALIGN_TOP);
      }
      { Fl_Value_Input* o = LightCutoffInput = new Fl_Value_Input(134, 300, 60, 25, "Cutoff");
        o->maximum(500000);
        o->step(0.1);
    ...
    { Fl_Group* o = InfiniteLightGroup = new Fl_Group(130, 279, 142, 50, "Azimuth/Elevation");
      o->box(FL_THIN_DOWN_BOX);
      o->hide();
      { Fl_Value_Input* o = InfLightElevInput = new Fl_Value_Input(202, 300, 60, 25, "Elev.");
        o->maximum(500000);
        o->step(0.1);
        o->callback((Fl_Callback*)cb_InfLightElevInput, (void*)(this));
        o->align(FL_ALIGN_TOP);
      }
      { Fl_Value_Input* o = InfLightAzInput = new Fl_Value_Input(134, 300, 60, 25, "Az.");
        o->maximum(500000);
        o->step(0.1);
        o->callback((Fl_Callback*)cb_InfLightAzInput, (void*)(this));
        o->align(FL_ALIGN_TOP);
      }
      o->end();
    }

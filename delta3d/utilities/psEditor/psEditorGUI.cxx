...
Fl_Double_Window* make_window() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = new Fl_Double_Window(1238, 587, "Particle System Editor");
    w = o;
    { Fl_Menu_Bar* o = MainMenu = new Fl_Menu_Bar(5, 5, 1230, 25);
      o->menu(menu_MainMenu);
    }
    { Fl_Tabs* o = new Fl_Tabs(635, 36, 600, 549);
      { Fl_Group* o = new Fl_Group(635, 57, 590, 515, "Particles");
        { Fl_Choice* o = Particles_Alignment = new Fl_Choice(710, 67, 105, 25, "Alignment");
          o->down_box(FL_BORDER_BOX);
          o->callback((Fl_Callback*)psEditorGUI_Particles_SetAlignment);
          o->menu(menu_Particles_Alignment);
        }
        { Fl_Choice* o = Particles_Shape = new Fl_Choice(710, 102, 150, 25, "Shape");
          o->down_box(FL_BORDER_BOX);
          o->callback((Fl_Callback*)psEditorGUI_Particles_SetShape);
          o->menu(menu_Particles_Shape);
        }
        { Fl_Value_Input* o = Particles_Lifetime = new Fl_Value_Input(710, 137, 80, 25, "Life(sec)");
        ...
        { Fl_Value_Input* o = Particles_MinSize = new Fl_Value_Input(710, 242, 80, 25, "Size (m)");
        ...
        { Fl_Value_Input* o = Particles_MaxSize = new Fl_Value_Input(810, 242, 80, 25, "to");
        ...
        { Fl_Value_Input* o = Particles_Radius = new Fl_Value_Input(710, 172, 80, 25, "Radius");
          o->maximum(10);
          o->step(0.01);
          o->value(0.2);
          o->callback((Fl_Callback*)psEditorGUI_Particles_SetRadius);
        }
        { Fl_Value_Input* o = Particles_Mass = new Fl_Value_Input(710, 207, 80, 25, "Mass");
          o->maximum(10);
          o->step(0.01);
          o->value(0.1);
          o->callback((Fl_Callback*)psEditorGUI_Particles_SetMass);
        }
        { Fl_Input* o = Particles_Texture = new Fl_Input(880, 66, 291, 25, "Texture");
        ...
        { Fl_Group* o = new Fl_Group(710, 285, 140, 125);
          o->box(FL_ENGRAVED_BOX);
          { Fl_Value_Input* o = Particles_MinR = new Fl_Value_Input(730, 291, 80, 25, "R");
            o->tooltip("Start color Red");
            o->step(0.01);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetMinR);
          }
          { Fl_Value_Input* o = Particles_MinG = new Fl_Value_Input(730, 321, 80, 25, "G");
            o->tooltip("Start color green");
            o->step(0.01);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetMinG);
          }
          { Fl_Value_Input* o = Particles_MinB = new Fl_Value_Input(730, 351, 80, 25, "B");
            o->tooltip("Start color blue");
            o->step(0.01);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetMinB);
          }
          { Fl_Button* o = Particles_MinColor = new Fl_Button(815, 291, 25, 85, "...");
            o->callback((Fl_Callback*)psEditorGUI_Particles_ChooseMinColor);
          }
          { Fl_Value_Input* o = Particles_MinAlpha = new Fl_Value_Input(729, 380, 80, 25, "A");
        ...
        new Fl_Box(665, 347, 45, 25, "Color");
        { Fl_Group* o = new Fl_Group(875, 285, 140, 125);
          o->box(FL_ENGRAVED_BOX);
          { Fl_Value_Input* o = Particles_MaxR = new Fl_Value_Input(895, 291, 80, 25, "R");
            o->tooltip("End color red");
            o->step(0.01);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetMaxR);
          }
          { Fl_Value_Input* o = Particles_MaxG = new Fl_Value_Input(895, 321, 80, 25, "G");
            o->tooltip("End color green");
            o->step(0.01);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetMaxG);
          }
          { Fl_Value_Input* o = Particles_MaxB = new Fl_Value_Input(895, 351, 80, 25, "B");
            o->tooltip("End color blue");
            o->step(0.01);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetMaxB);
          }
          { Fl_Button* o = Particles_MaxColor = new Fl_Button(980, 291, 25, 85, "...");
            o->callback((Fl_Callback*)psEditorGUI_Particles_ChooseMaxColor);
          }
          { Fl_Value_Input* o = Particles_MaxAlpha = new Fl_Value_Input(896, 380, 80, 25, "A");
        ...
        new Fl_Box(850, 347, 25, 25, "to");
        { Fl_Group* o = new Fl_Group(710, 419, 305, 120, "Emitter");
          o->box(FL_ENGRAVED_BOX);
          o->align(FL_ALIGN_LEFT);
          { Fl_Check_Button* o = Particles_Emitter_Endless = new Fl_Check_Button(927, 469, 80, 25, "Forever");
            o->tooltip("Does the emitter endlessly emit particles?");
            o->down_box(FL_DOWN_BOX);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetEmitterEndless);
          }
          { Fl_Value_Input* o = Particles_Emitter_Lifetime = new Fl_Value_Input(827, 434, 80, 25, "Life(sec)");
          ...
          { Fl_Value_Input* o = Particles_Emitter_StartTime = new Fl_Value_Input(827, 469, 80, 25, "Start Time (sec)");
            o->tooltip("The amount of delay before emitting");
            o->maximum(10);
            o->step(0.01);
            o->callback((Fl_Callback*)psEditorGUI_Particles_SetEmitterStartTime);
          }
          { Fl_Value_Input* o = Particles_Emitter_ResetTime = new Fl_Value_Input(827, 504, 80, 25, "Reset Time (sec)");
      ...
      { Fl_Group* o = new Fl_Group(635, 57, 590, 515, "Counter");
        o->hide();
        { Fl_Group* o = RandomRateCounterParameters = new Fl_Group(640, 302, 580, 160, "Random Rate Counter Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Value_Input* o = RandomRateCounter_MinRate = new Fl_Value_Input(920, 347, 80, 25, "Min. Rate (particles/sec)");
          ...
          { Fl_Value_Input* o = RandomRateCounter_MaxRate = new Fl_Value_Input(920, 382, 80, 25, "Max. Rate (particles/sec)");
        ...
        { Fl_Choice* o = new Fl_Choice(855, 122, 180, 25, "Counter Type");
          o->down_box(FL_BORDER_BOX);
      ...
      { Fl_Group* o = new Fl_Group(635, 57, 590, 515, "Placer");
        o->hide();
        { Fl_Group* o = SegmentPlacerParameters = new Fl_Group(640, 302, 580, 160, "Segment Placer Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Group* o = new Fl_Group(660, 332, 260, 105, "Vertex A");
            o->box(FL_ENGRAVED_BOX);
            { Fl_Value_Input* o = SegmentPlacer_A_X = new Fl_Value_Input(750, 342, 80, 25, "X");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->value(-1);
            ...
            { Fl_Value_Input* o = SegmentPlacer_A_Y = new Fl_Value_Input(750, 372, 80, 25, "Y");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->callback((Fl_Callback*)psEditor_SegmentPlacer_VertexA_SetY);
            }
            { Fl_Value_Input* o = SegmentPlacer_A_Z = new Fl_Value_Input(750, 402, 80, 25, "Z");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
          ...
          { Fl_Group* o = new Fl_Group(940, 332, 260, 105, "Vertex B");
            o->box(FL_ENGRAVED_BOX);
            { Fl_Value_Input* o = SegmentPlacer_B_X = new Fl_Value_Input(1030, 342, 80, 25, "X");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->value(1);
            ...
            { Fl_Value_Input* o = SegmentPlacer_B_Y = new Fl_Value_Input(1030, 372, 80, 25, "Y");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->callback((Fl_Callback*)psEditor_SegmentPlacer_VertexB_SetY);
            }
            { Fl_Value_Input* o = SegmentPlacer_B_Z = new Fl_Value_Input(1030, 402, 80, 25, "Z");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
        ...
        { Fl_Group* o = SectorPlacerParameters = new Fl_Group(640, 302, 580, 160, "Sector Placer Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Group* o = new Fl_Group(655, 327, 165, 105, "Center");
            o->box(FL_ENGRAVED_BOX);
            { Fl_Value_Input* o = SectorPlacer_X = new Fl_Value_Input(700, 337, 80, 25, "X");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->callback((Fl_Callback*)psEditorGUI_SectorPlacer_Center_SetX);
            }
            { Fl_Value_Input* o = SectorPlacer_Y = new Fl_Value_Input(700, 367, 80, 25, "Y");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->callback((Fl_Callback*)psEditorGUI_SectorPlacer_Center_SetY);
            }
            { Fl_Value_Input* o = SectorPlacer_Z = new Fl_Value_Input(700, 397, 80, 25, "Z");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
          ...
          { Fl_Value_Input* o = SectorPlacer_MinRadius = new Fl_Value_Input(930, 352, 80, 25, "Min. Radius");
            o->maximum(10);
            o->step(0.1);
            o->callback((Fl_Callback*)psEditorGUI_SectorPlacer_SetMinRadius);
          }
          { Fl_Value_Input* o = SectorPlacer_MaxRadius = new Fl_Value_Input(930, 382, 80, 25, "Max. Radius");
            o->maximum(10);
            o->step(0.1);
            o->value(1);
            o->callback((Fl_Callback*)psEditorGUI_SectorPlacer_SetMaxRadius);
          }
          { Fl_Value_Input* o = SectorPlacer_MinPhi = new Fl_Value_Input(1110, 352, 80, 25, "Min. Phi");
            o->maximum(6.2832);
            o->step(0.01);
            o->callback((Fl_Callback*)psEditorGUI_SectorPlacer_SetMinPhi);
          }
          { Fl_Value_Input* o = SectorPlacer_MaxPhi = new Fl_Value_Input(1110, 382, 80, 25, "Max. Phi");
            o->maximum(6.2832);
            o->step(0.01);
            o->value(6.2832);
        ...
        { Fl_Group* o = PointPlacerParameters = new Fl_Group(640, 302, 580, 160, "Point Placer Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Value_Input* o = PointPlacer_X = new Fl_Value_Input(890, 332, 80, 25, "X");
            o->minimum(-10);
            o->maximum(10);
            o->step(0.1);
            o->callback((Fl_Callback*)psEditorGUI_PointPlacer_SetX);
          }
          { Fl_Value_Input* o = PointPlacer_Y = new Fl_Value_Input(890, 362, 80, 25, "Y");
            o->minimum(-10);
            o->maximum(10);
            o->step(0.1);
            o->callback((Fl_Callback*)psEditorGUI_PointPlacer_SetY);
          }
          { Fl_Value_Input* o = PointPlacer_Z = new Fl_Value_Input(890, 392, 80, 25, "Z");
            o->minimum(-10);
            o->maximum(10);
            o->step(0.1);
        ...
        { Fl_Group* o = MultiSegmentPlacerParameters = new Fl_Group(640, 302, 580, 160, "Multi Segment Placer Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Browser* o = MultiSegmentPlacer_Vertices = new Fl_Browser(650, 312, 170, 105, "Vertices");
            o->type(2);
            o->callback((Fl_Callback*)psEditorGUI_MultiSegmentPlacer_VerticesChanged);
          }
          { Fl_Button* o = new Fl_Button(825, 362, 115, 25, "Add Vertex");
            o->callback((Fl_Callback*)psEditorGUI_MultiSegmentPlacer_AddVertex);
          }
          { Fl_Button* o = MultiSegmentPlacer_DeleteVertex = new Fl_Button(825, 392, 115, 25, "Delete Vertex");
            o->callback((Fl_Callback*)psEditorGUI_MultiSegmentPlacer_DeleteVertex);
          }
          { Fl_Group* o = MultiSegmentPlacer_VertexParameters = new Fl_Group(980, 312, 230, 105, "Vertex Parameters");
            o->box(FL_ENGRAVED_BOX);
            o->align(FL_ALIGN_BOTTOM);
            o->hide();
            { Fl_Value_Input* o = MultiSegmentPlacer_X = new Fl_Value_Input(1060, 322, 80, 25, "X");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->callback((Fl_Callback*)psEditorGUI_MultiSegmentPlacer_Vertex_SetX);
            }
            { Fl_Value_Input* o = MultiSegmentPlacer_Y = new Fl_Value_Input(1060, 352, 80, 25, "Y");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
              o->callback((Fl_Callback*)psEditorGUI_MultiSegmentPlacer_Vertex_SetY);
            }
            { Fl_Value_Input* o = MultiSegmentPlacer_Z = new Fl_Value_Input(1060, 382, 80, 25, "Z");
              o->minimum(-10);
              o->maximum(10);
              o->step(0.1);
        ...
        { Fl_Choice* o = new Fl_Choice(865, 137, 155, 25, "Placer Type");
          o->down_box(FL_BORDER_BOX);
      ...
      { Fl_Group* o = new Fl_Group(635, 57, 590, 515, "Shooter");
        o->hide();
        { Fl_Group* o = RadialShooterParameters = new Fl_Group(640, 302, 580, 270, "Radial Shooter Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          { Fl_Group* o = new Fl_Group(662, 332, 163, 64, "Elevation Range");
            o->tooltip("The elevation range the Shooter will send each particle. 0=up, 3.14=down");
            o->box(FL_ENGRAVED_FRAME);
            { Fl_Value_Input* o = RadialShooter_MinTheta = new Fl_Value_Input(735, 336, 85, 25, "Min (rad)");
            ...
            { Fl_Value_Input* o = RadialShooter_MaxTheta = new Fl_Value_Input(735, 366, 85, 25, "Max (rad)");
          ...
          { Fl_Group* o = new Fl_Group(849, 332, 163, 64, "Azimuth Range");
            o->tooltip("The azimuth range the Shooter will send each particle. 0 = X axis, 3.14 = -X \
axis");
            o->box(FL_ENGRAVED_FRAME);
            { Fl_Value_Input* o = RadialShooter_MinPhi = new Fl_Value_Input(922, 337, 85, 25, "Min (rad)");
            ...
            { Fl_Value_Input* o = RadialShooter_MaxPhi = new Fl_Value_Input(922, 367, 85, 25, "Max (rad)");
          ...
          { Fl_Group* o = new Fl_Group(1038, 332, 163, 64, "Initial Velocity Range");
            o->tooltip("The initial velocity range the Shooter will send each particle");
            o->box(FL_ENGRAVED_FRAME);
            { Fl_Value_Input* o = RadialShooter_MinInitialSpeed = new Fl_Value_Input(1111, 337, 85, 25, "Min (m/s)");
            ...
            { Fl_Value_Input* o = RadialShooter_MaxInitialSpeed = new Fl_Value_Input(1111, 367, 85, 25, "Max (m/s)");
          ...
          { Fl_Group* o = new Fl_Group(671, 422, 505, 113, "Initial Rotational Velocity Range");
            o->tooltip("The inital rotational velocity range the Shooter applies to each particle");
            o->box(FL_ENGRAVED_BOX);
            { Fl_Group* o = new Fl_Group(761, 431, 138, 94, "Min(rad/sec)");
              o->box(FL_ENGRAVED_FRAME);
              o->align(FL_ALIGN_LEFT);
              { Fl_Value_Input* o = RadialShooter_MinInitialRotationalSpeedX = new Fl_Value_Input(809, 436, 85, 25, "X Axis");
                o->minimum(-10);
                o->maximum(10);
                o->step(0.1);
                o->callback((Fl_Callback*)psEditorGUI_RadialShooter_SetMinInitialRotationalSpeedX);
              }
              { Fl_Value_Input* o = RadialShooter_MinInitialRotationalSpeedY = new Fl_Value_Input(809, 466, 85, 25, "Y Axis");
                o->minimum(-10);
                o->maximum(10);
                o->step(0.1);
                o->callback((Fl_Callback*)psEditorGUI_RadialShooter_SetMinInitialRotationalSpeedY);
              }
              { Fl_Value_Input* o = RadialShooter_MinInitialRotationalSpeedZ = new Fl_Value_Input(809, 496, 85, 25, "Z Axis");
                o->minimum(-10);
                o->maximum(10);
                o->step(0.1);
            ...
            { Fl_Group* o = new Fl_Group(1017, 431, 138, 94, "Max(rad/sec)");
              o->box(FL_ENGRAVED_FRAME);
              o->align(FL_ALIGN_LEFT);
              { Fl_Value_Input* o = RadialShooter_MaxInitialRotationalSpeedX = new Fl_Value_Input(1064, 436, 85, 25, "X Axis");
                o->minimum(-10);
                o->maximum(10);
                o->step(0.1);
                o->callback((Fl_Callback*)psEditorGUI_RadialShooter_SetMaxInitialRotationalSpeedX);
              }
              { Fl_Value_Input* o = RadialShooter_MaxInitialRotationalSpeedY = new Fl_Value_Input(1064, 466, 85, 25, "Y Axis");
                o->minimum(-10);
                o->maximum(10);
                o->step(0.1);
                o->callback((Fl_Callback*)psEditorGUI_RadialShooter_SetMaxInitialRotationalSpeedY);
              }
              { Fl_Value_Input* o = RadialShooter_MaxInitialRotationalSpeedZ = new Fl_Value_Input(1064, 496, 85, 25, "Z Axis");
                o->minimum(-10);
                o->maximum(10);
                o->step(0.1);
        ...
        { Fl_Choice* o = new Fl_Choice(860, 132, 150, 25, "Shooter Type");
          o->down_box(FL_BORDER_BOX);
      ...
      { Fl_Group* o = new Fl_Group(635, 62, 590, 510, "Program");
        o->hide();
        { Fl_Browser* o = Program_Operators = new Fl_Browser(765, 117, 150, 130, "Operators");
          o->type(2);
          o->callback((Fl_Callback*)psEditor_Program_OperatorsChanged);
          o->align(FL_ALIGN_TOP);
        }
        { Fl_Button* o = new Fl_Button(925, 117, 130, 25, "New Force");
          o->callback((Fl_Callback*)psEditorGUI_Program_NewForce);
        }
        { Fl_Button* o = new Fl_Button(925, 152, 130, 25, "New Acceleration");
          o->callback((Fl_Callback*)psEditorGUI_Program_NewAcceleration);
        }
        { Fl_Button* o = new Fl_Button(925, 187, 130, 25, "New Fluid Friction");
          o->callback((Fl_Callback*)psEditorGUI_Program_NewFluidFriction);
        }
        { Fl_Button* o = Program_DeleteOperator = new Fl_Button(925, 222, 130, 25, "Delete Operator");
          o->callback((Fl_Callback*)psEditorGUI_Program_DeleteOperator);
        }
        { Fl_Group* o = FluidFrictionParameters = new Fl_Group(640, 302, 580, 160, "Fluid Friction Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Button* o = new Fl_Button(945, 327, 90, 25, "Air");
            o->callback((Fl_Callback*)psEditorGUI_FluidFriction_Air);
          }
          { Fl_Button* o = new Fl_Button(945, 357, 90, 25, "Water");
            o->callback((Fl_Callback*)psEditorGUI_FluidFriction_Water);
          }
          { Fl_Value_Input* o = FluidFriction_Density = new Fl_Value_Input(850, 327, 80, 25, "Density");
            o->step(0.001);
            o->value(1.2929);
            o->callback((Fl_Callback*)psEditorGUI_FluidFriction_SetDensity);
          }
          { Fl_Value_Input* o = FluidFriction_Viscosity = new Fl_Value_Input(850, 357, 80, 25, "Viscosity");
            o->step(0.0001);
            o->value(1.8e-005);
            o->callback((Fl_Callback*)psEditorGUI_FluidFriction_SetViscosity);
          }
          { Fl_Value_Input* o = FluidFriction_OverrideRadius = new Fl_Value_Input(850, 387, 80, 25, "Override Radius");
            o->maximum(10);
            o->step(0.1);
        ...
        { Fl_Group* o = ForceParameters = new Fl_Group(640, 302, 580, 160, "Force Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Value_Input* o = Force_X = new Fl_Value_Input(870, 332, 115, 25, "X");
          ...
          { Fl_Value_Input* o = Force_Y = new Fl_Value_Input(870, 362, 115, 25, "Y");
          ...
          { Fl_Value_Input* o = Force_Z = new Fl_Value_Input(870, 392, 115, 25, "Z");
        ...
        { Fl_Group* o = AccelerationParameters = new Fl_Group(640, 302, 580, 160, "Acceleration Parameters");
          o->box(FL_DOWN_BOX);
          o->align(FL_ALIGN_BOTTOM|FL_ALIGN_INSIDE);
          o->hide();
          { Fl_Value_Input* o = Acceleration_X = new Fl_Value_Input(870, 332, 115, 25, "X");
            o->minimum(-10);
            o->maximum(10);
            o->step(0.1);
            o->callback((Fl_Callback*)psEditorGUI_Acceleration_SetX);
          }
          { Fl_Value_Input* o = Acceleration_Y = new Fl_Value_Input(870, 362, 115, 25, "Y");
            o->minimum(-10);
            o->maximum(10);
            o->step(0.1);
            o->callback((Fl_Callback*)psEditorGUI_Acceleration_SetY);
          }
          { Fl_Value_Input* o = Acceleration_Z = new Fl_Value_Input(870, 392, 115, 25, "Z");
            o->minimum(-10);
            o->maximum(10);
            o->step(0.1);
    ...
    { Fl_DT_Window<dtABC::Widget>* o = viewWidget = new Fl_DT_Window<dtABC::Widget>(5, 35, 625, 550);
      o->box(FL_NO_BOX);
      o->color(FL_BACKGROUND_COLOR);
      o->selection_color(FL_BACKGROUND_COLOR);
      o->labeltype(FL_NORMAL_LABEL);

...
#  ifdef DT_DIRECTOR_TOOL_PLUGIN
#    define DT_DIRECTOR_TOOL_EXPORT __declspec(dllexport)
#  else
#    define DT_DIRECTOR_TOOL_EXPORT __declspec(dllimport)
#  endif
#else
#  ifdef DT_DIRECTOR_TOOL_PLUGIN
#    define DT_DIRECTOR_TOOL_EXPORT  __attribute__ ((visibility("default")))
#  else
#    define DT_DIRECTOR_TOOL_EXPORT
#  endif
#endif

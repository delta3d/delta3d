...
#
# Macro:
#   ADD_PRECOMPILED_HEADER  _targetName _input _include_name  _dowarn
#   ADD_PRECOMPILED_HEADER_TO_TARGET _targetName _input _include_name _pch_output_to_use _dowarn
...
MACRO(_PCH_GET_COMPILE_FLAGS BUILD_TYPE _out_compile_flags)
  ...
  GET_TARGET_PROPERTY(_TARGET_DEFINE_SYMBOL ${_PCH_current_target} DEFINE_SYMBOL)
  IF (_TARGET_DEFINE_SYMBOL)
     LIST(APPEND ${_out_compile_flags} "${_PCH_define_prefix}${_TARGET_DEFINE_SYMBOL}")
...
MACRO(_PCH_GET_COMPILE_COMMAND out_command _input _output)
	...
	IF(CMAKE_COMPILER_IS_GNUCXX)
	    ...
	    SET(${out_command} 
	      ${CMAKE_CXX_COMPILER} ${pchsupport_compiler_cxx_arg1} ${_compile_FLAGS} -c -x c++-header -o ${_output} ${_input} 
	      )
	  ELSE(CMAKE_CXX_COMPILER_ARG1)
	    SET(${out_command} 
	      ${CMAKE_CXX_COMPILER}  ${_compile_FLAGS} -c -x c++-header -o ${_output} ${_input} 
	      )
...
MACRO(_PCH_GET_TARGET_COMPILE_FLAGS _cflags _include_name _header_name _pch_path _dowarn )
  ...
  ELSE(CMAKE_COMPILER_IS_GNUCXX)
    ...
    set(${_cflags} "/Fp${_native_pch_path} /Yu${_include_name}" )	
...
MACRO(ADD_PRECOMPILED_HEADER_TO_TARGET _targetName _input _include_name _pch_output_to_use )
  ...
  _PCH_GET_TARGET_COMPILE_FLAGS(_target_cflags ${_include_name} ${_name} ${_pch_output_to_use} ${_dowarn})
...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input _include_name)
  ...
  ADD_PRECOMPILED_HEADER_TO_TARGET(${_targetName} ${_input} ${_include_name}  ${_output} ${_dowarn})

...
#include "viewstate.h"
#define kDefFltr "Geometry Files (*.{osg,ive,flt,3ds,txp,xml})\tOSG Files (*.osg)\tIVE Files (*.ive)\tFlight Files (*.flt)\t3DS Export Files (*.3ds))\tTerraPage Files (*.txp)\tMap Files (*.xml)"

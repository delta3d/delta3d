...
const dtCore::ActorComponent::ACType TextLabelComponent::TYPE(new dtCore::ActorType("TextLabelComponent", "ActorComponents",
...
////////////////////////////////////////////////////////////////////////////////
void TextLabelComponent::OnAddedToActor(dtCore::BaseActor& actor)
{
   BaseClass::OnAddedToActor(actor);

   dtCore::DeltaDrawable* drawable = GetDrawable();

   // add text node geometry to drawable
   if (drawable != NULL)
   {
      drawable->GetOSGNode()->asGroup()->addChild(mGroup.get());
   }
}

////////////////////////////////////////////////////////////////////////////////
void TextLabelComponent::OnRemovedFromActor(dtCore::BaseActor& actor)
{
   ...
   if (drawable != NULL)
   {
      ...
      drawable->GetOSGNode()->asGroup()->removeChild(mGroup.get());
   }
}

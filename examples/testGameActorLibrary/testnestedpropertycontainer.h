 ...
 */
class TestNestedPropertyContainer : public dtCore::PropertyContainer
{
public:
...
public:
   ...
   void SetNestedPropContainer(int, TestNestedPropertyContainer* pc);
   TestNestedPropertyContainer* GetNestedPropContainer(int);
   void InsertNewNestedPropContainer(int);
   void RemoveNestedPropContainer(int);
   size_t GetNumNestedPropContainers() const;

private:
   virtual ~TestNestedPropertyContainer();
   std::vector<dtCore::RefPtr<TestNestedPropertyContainer> > mNestedContainers;
};

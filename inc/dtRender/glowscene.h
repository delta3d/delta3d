...
* Bradley Anderegg
*/
#ifndef DELTA_GLOWSCENE_H
#define DELTA_GLOWSCENE_H
...
namespace dtRender
{
   ...
   class DT_RENDER_EXPORT GlowScene : public PPUScene
   {
   public:
      typedef PPUScene BaseClass;
      static const dtCore::RefPtr<SceneType> GLOW_SCENE;

...
namespace dtDAL
{
    ...
    */
   class DT_DAL_EXPORT BasePropertyContainerActorProperty : public ActorProperty
   {
   public:
      ...
      virtual dtDAL::PropertyContainer* GetValue() const = 0;
      virtual void SetValue(dtDAL::PropertyContainer* value) = 0;
   ...
   public:
      ...
      virtual dtDAL::PropertyContainer* GetValue() const
      {
         return mGetFunc();
      }

      virtual void SetValue(dtDAL::PropertyContainer* value)
      {

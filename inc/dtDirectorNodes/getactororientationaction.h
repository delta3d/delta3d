...
#pragma once
#ifndef GetActorOrientationAction_h__
#define GetActorOrientationAction_h__
...
{
   ////////////////////////////////////////////////////////////////////////////////
   class NODE_LIBRARY_EXPORT GetActorOrientationAction : public ActionNode
   {
   public:
      /**
       * Constructor.
       */
      GetActorOrientationAction();
      ...
      void SetEmptyVec(const osg::Vec3& value);
      osg::Vec3 GetEmptyVec() const;
...
#endif // GetActorOrientationAction_h__

...
namespace dtGame
{
    ...
    */
   class DT_GAME_EXPORT DeadReckoningActorComponent : public dtCore::ActorComponent , public dtCore::MotionInterface
   {
      public:
...
//               float mPosSplineZA, mPosSplineZB, mPosSplineZC, mPosSplineZD; // z spline pre-compute values
         ...
         virtual void OnParentAdded(dtCore::BaseActor& actor);
         virtual void OnParentRemoved(dtCore::BaseActor& actor);

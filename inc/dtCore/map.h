   ...
   class DT_CORE_EXPORT Map : public osg::Referenced 
   {
      public:
         ...
         */
          ...
          * @return A pointer to the environment actor or NULL
          */
         const BaseActor* GetEnvironmentActor() const;
          ...
          */
         void SetEnvironmentActor(BaseActor* envActor);
         ...
         */
         ...
         dtCore::BaseActor* GetDrawableActorHierarchy() { return mDrawableActorHierarchy; }
      ...
      protected:
       ...
       private:
         ...
         dtCore::RefPtr<dtCore::BaseActor> mEnvActor;

         dtCore::RefPtr<dtCore::BaseActor> mDrawableActorHierarchy;

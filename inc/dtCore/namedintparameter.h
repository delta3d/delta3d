...
#ifndef DELTA_NAMED_INT_PARAMETER
#define DELTA_NAMED_INT_PARAMETER
...
namespace dtCore
{
   /**
     ...
     */
   class DT_CORE_EXPORT NamedIntParameter: public NamedPODParameter<int>
   {
      public:
...
#endif //DELTA_NAMED_INT_PARAMETER

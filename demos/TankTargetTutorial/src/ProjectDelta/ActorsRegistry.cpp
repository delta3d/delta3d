...
dtCore::RefPtr<dtDAL::ActorType> ActorsRegistry::KILLABLE_ACTOR_TYPE( new dtDAL::ActorType( "Killable Target", "MyActors.Targets", "Would wouldn't want to shoot this thing?" ) );

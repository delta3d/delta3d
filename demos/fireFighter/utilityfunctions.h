...
{
	float x1, y1, z1, h1, p1, r1, sx, sy, sz;
	
	startPos->Get(x1, y1, z1, h1, p1, r1, sx, sy, sz);

	if(relative)
		newX += x1;

	startPos->Set(newX, y1, z1, h1, p1, r1, sx, sy, sz);
}
...
inline void AdjustY(dtCore::Transform* startPos, float newY, bool relative = false)
{
	...
	startPos->Set(x1, newY, z1, h1, p1, r1, sx, sy, sz);
}
...
inline void AdjustZ(dtCore::Transform* startPos, float newZ, bool relative = false)
{
	...
	startPos->Set(x1, y1, newZ, h1, p1, r1, sx, sy, sz);
}
...
inline void AdjustH(dtCore::Transform* startPos, float newH, bool relative = false)
{
	...
	startPos->Set(x1, y1, z1, newH, p1, r1, sx, sy, sz);
}
...
inline void AdjustP(dtCore::Transform* startPos, float newP, bool relative = false)
{
	...
	startPos->Set(x1, y1, z1, h1, newP, r1, sx, sy, sz);
}
...
inline void AdjustR(dtCore::Transform* startPos, float newR, bool relative = false)
{
	...
	startPos->Set(x1, y1, z1, h1, p1, newR, sx, sy, sz);
}
...
inline dtCore::Transform Offset2DPosition(dtCore::Transform* startPos, dtCore::Transform* offsetPos)
{
	...
	float x1, y1, z1, h1, p1, r1, sx1, sy1, sz1;
	float x2, y2, z2, h2, p2, r2, sx2, sy2, sz2;
	
	startPos->Get(x1, y1, z1, h1, p1, r1, sx1, sy1, sz1);
	offsetPos->Get(x2, y2, z2, h2, p2, r2, sx2, sy2, sz2);

...
namespace dtRender
{
   const dtCore::ActorComponent::ACType UniformActComp::TYPE(new dtCore::ActorType("UniformActComp", "ActorComponents",
   ...
   void UniformActComp::OnAddedToActor(dtCore::BaseActor& actor)
   {
      BaseClass::OnAddedToActor(actor);
   }

   void UniformActComp::OnRemovedFromActor(dtCore::BaseActor& actor)
   {

...
{ // "display name", "category", "description/tooltip"
   dtCore::RefPtr<dtCore::ActorType> EngineActorRegistry::EMPTY_ACTOR_TYPE(new dtCore::ActorType("Empty", "dtcore", "Basic empty actor with no properties or behaviors."));
   ...
   void EngineActorRegistry::RegisterActorTypes()
   {
      ...
      mActorFactory->RegisterType<dtCore::EmptyActor>(EMPTY_ACTOR_TYPE.get());

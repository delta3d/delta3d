...
namespace dtGame
{
   ...
   const dtCore::ActorComponent::ACType CascadingDeleteActorComponent::TYPE(new dtCore::ActorType("CascadingDeleteActorComponent", "ActorComponents",
         "Deletes associated actors when the owner is deleted.", dtCore::ActorComponent::BaseActorComponentType));

   const dtCore::ActorComponent::ACType ShaderActorComponent::TYPE(new dtCore::ActorType("ShaderActorComponent", "ActorComponents",
         "Moves, rotates, and ground-clamps actors based on dead-reckoning data.  It also receives the updates from the network.",
         dtCore::ActorComponent::BaseActorComponentType));

   const dtCore::ActorComponent::ACType DeadReckoningActorComponent::TYPE(new dtCore::ActorType("DeadReckoningActComp", "ActorComponents",
         "Moves, rotates, and ground-clamps actors based on dead-reckoning data.  It also receives the updates from the network.",
         dtCore::ActorComponent::BaseActorComponentType));

   const dtCore::ActorComponent::ACType DRPublishingActComp::TYPE(new dtCore::ActorType("DRPublishingActComp", "ActorComponents",

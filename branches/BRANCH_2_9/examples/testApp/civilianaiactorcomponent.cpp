...
namespace dtExample
{
   ...
   const dtCore::ActorComponent::ACType CivilianAIActorComponent::TYPE( new dtCore::ActorType("CivilianAI", "ActorComponents", "", dtCore::ActorComponent::BaseActorComponentType));
   ...
   ///////////////////////////////////////////////////////////////////////////////////
   void CivilianAIActorComponent::OnAddedToActor(dtCore::BaseActor& actor)
   {
      ...
      {
         owner->AddChild(* new dtAnim::AnimationTransitionPlanner);
      }

      if (owner->GetComponentByType(*dtGame::DeadReckoningActorComponent::TYPE) == NULL)
      {
         owner->AddChild(* new dtGame::DeadReckoningActorComponent);
      }

      if (owner->GetComponentByType(*dtGame::DRPublishingActComp::TYPE) == NULL)
      {
         owner->AddChild(* new dtGame::DRPublishingActComp);
      }

      dtPhysics::PhysicsActComp* pac = owner->GetComponent<dtPhysics::PhysicsActComp>();
      ...
      owner->GetComponent<dtAnim::AnimationHelper>()->ModelLoadedSignal.connect_slot(this, &CivilianAIActorComponent::OnModelLoaded);

   }

   ///////////////////////////////////////////////////////////////////////////////////
   void CivilianAIActorComponent::OnRemovedFromActor(dtCore::BaseActor& actor)
   {

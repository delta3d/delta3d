...
static const dtUtil::RefString CONF_MGR_SHOW_PROPERTY_EDITOR_NEW("ShowPropertyEditor_New");
static const dtUtil::RefString CONF_MGR_SHOW_SHADER_PARAMS_EDITOR("ShowShaderParamsEditor");

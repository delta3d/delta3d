  ...
  , mExitAct(NULL)
{
   ...
   mPropertiesPanel = new dtQt::PropertyPanel;
   mPropertiesDock->setWidget(mPropertiesPanel);

   // DEBUG:
   /*mPropertiesPanel->AddProperty("ENUMERATION", "Test Enum");
   //mPropertiesPanel->AddProperty("RANGE", "Test Range");
   mPropertiesPanel->AddProperty("RGBACOLOR", "Test Color");
   mPropertiesPanel->AddProperty("BOOLEAN", "Test Bool");
   mPropertiesPanel->AddProperty("INT", "Test Int");
   mPropertiesPanel->AddProperty("FLOAT", "Test Float");
   mPropertiesPanel->AddProperty("DOUBLE", "Test Double");
   mPropertiesPanel->AddProperty("STRING", "Test String");
   mPropertiesPanel->AddProperty("Textures", "Test Image");
   mPropertiesPanel->AddProperty("ARRAY", "Test Array");
   mPropertiesPanel->AddProperty("BIT_MASK", "Test BitMask");*/
...
////////////////////////////////////////////////////////////////////////////////
void ObjectWorkspace::CreateConnections()
{
...
////////////////////////////////////////////////////////////////////////////////
void ObjectWorkspace::OnTogglePropertiesDock()
{
   if (mPropertiesDock->isHidden())
   {

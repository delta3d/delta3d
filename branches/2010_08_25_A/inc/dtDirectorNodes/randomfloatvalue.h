...
#ifndef DIRECTOR_RANDOM_FLOAT_VALUE_NODE
#define DIRECTOR_RANDOM_FLOAT_VALUE_NODE
...
namespace dtDirector
{
    ...
    */
   class NODE_LIBRARY_EXPORT RandomFloatValue : public ValueNode
   {
   public:

...
namespace dtGame
{
   ...
   const MessageType MessageType::INFO_MAP_LOAD_BEGIN("Map Load Began", "Info", "Sent when loading a map has begun.", 23, (MapMessage*)(NULL));
   const MessageType MessageType::INFO_MAP_UNLOAD_BEGIN("Map Unload Began", "Info", "Sent when unloading a map has begun.", 24, (MapMessage*)(NULL));
   ...
   const MessageType MessageType::INFO_MAP_CHANGED("Map Changed", "Info", "Sent when the program has completed unloading and loading a new map.", 26, (MapMessage*)(NULL));

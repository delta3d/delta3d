...
extern Prof_C DT_EXPORT Prof_Zone_Stack * Prof_stack; // current Zone stack
extern Prof_C DT_EXPORT Prof_Zone_Stack   Prof_dummy; // parent never matches

extern Prof_C DT_EXPORT Prof_Zone_Stack * Prof_StackAppend(Prof_Zone *zone);

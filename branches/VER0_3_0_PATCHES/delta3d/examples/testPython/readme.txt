...
flyplane.py: should be run from the prompt within testPython to fly the plane 
             in a circle.
...
testPython.py: also flies a plane in a circle, but should be run straight from
...
- The resulting window should also show a plane flying in a circle.

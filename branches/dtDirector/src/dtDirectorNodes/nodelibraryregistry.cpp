...
namespace dtDirector
{
   ...
   RefPtr<NodeType> NodeLibraryRegistry::REFERENCE_VALUE_NODE_TYPE(new dtDirector::NodeType("Reference", "General", "Variables", "This will reference another value in the script."));

...
namespace dtUtil {
    ...
    template<typename UniqueIdType,
                typename BaseType,
                class ltCmp=std::less<UniqueIdType> >
    class ObjectFactory {
    private:
        /**
    ...
    public:
        ...
        /**
         * Compiler complains if we do not make the following a typename.
         */
        typedef typename
            std::map<UniqueIdType,createObjectFunc,ltCmp>::iterator ObjTypeItor;
        ...
        BaseType *CreateObject(UniqueIdType id)
        {
            ...
            if (itor == this->objectTypeMap.end()) {
                std::ostringstream ss;
                ss << "Unable to create object of type: " << id <<
                    " Reason: Unknown type.";
    ...
    private:
       ...
       std::map<UniqueIdType,createObjectFunc,ltCmp> objectTypeMap;
    };
}
